  ...
  <div class="moving-news-edit">
    ...
    >
      ...
      >
        ...
        <a-form-item label="标签" required name="tag" help="标签以逗号隔开，末尾逗号可以省略">
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      const { id, imageId, content, title, top, online, summary, tag, sortIndex, classId } = this.info
