...
import { getList, getClassDataInfo } from '@/apis/class'
...
export default {
  ...
  methods: {
    ...
    infoInit(data) {
      const { id, classId, imageId, fullImage, content, title, tag, top, online, summary, sortIndex } = data || {}
      const form = {
