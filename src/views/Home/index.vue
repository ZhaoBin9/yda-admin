...
import { getList, deleteData } from '@/apis/home'
...
export default {
  ...
  methods: {
    ...
    handleAdd() {
      this.editModal.data = this.infoInit()
      this.editModal.title = '新增'
      this.editModal.show = true
    },
    infoInit(data) {
      const { id, imageId, fullImage, online, summary, sortIndex, type, href } = data || {}
      const form = {
